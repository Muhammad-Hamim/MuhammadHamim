...
const Features = () => {
  ...
  const features = [
    {
      ...
      description:
        "Building modern, interactive web applications using React.js, Next.js, and other cutting-edge technologies.",
    ...
    },
    {
      ...
      description:
        "Creating robust backend solutions with Node.js, Express, and database management systems.",
    ...
    },
    {
      ...
      description:
        "Implementing advanced optimization techniques for lightning-fast web applications.",
  ...
  return (
    <div id="features" className="py-32 bg-gray-900">
      ...
      <motion.div
        className="container lg:max-w-7xl mx-auto px-4 grid md:grid-cols-2 lg:grid-cols-2 gap-8 mt-16"
